...
const Productdetails = () => {
   ...
   const getsimilarproduct=async(pid,cid)=>{
    try{
      console.log({pid,cid});
      const {data}=await axios.get(`https://ecommerce-backend-api.adaptable.app/product/similarproduct/${pid}/${cid}`);
    ...
    <Layout title={`product-detail`}>
      {product && <div className="row container product-details">
        <div className="col-md-6 ">
          <img
            src={`https://ecommerce-backend-api.adaptable.app/product/getproduct-photo/${product._id}`}
