...
const Updateproduct = () => {
  ...
  const getsingleproduct=async()=>{
    try{
        const {data} =await axios.get(`https://ecommerce-backend-api.adaptable.app/product/getsingle-product/${params.slug}`);
        if(data?.success){
 ...
 const handleUpdate=async(e)=>{
   ...
   try{
      ...
      const {data}= await axios.put(`https://ecommerce-backend-api.adaptable.app/product/update-product/${id}`,productData);
      if(data?.success){
 ...
 const handleDelete=async(e)=>{
    e.preventDefault();
    try{
       const {data}=await axios.delete(`https://ecommerce-backend-api.adaptable.app/product/delete-product/${id}`);
       if(data?.success){
              ...
              <div className='card w-75 p-3'>
                ...
                <div className="m-1 w-75">
                  ...
                  <div className='mb-3'>
                    ...
                    <div className="text-center">
                        <img
                        src={`https://ecommerce-backend-api.adaptable.app/product/getproduct-photo/${id}`}
                        alt="product_photo"
                        height={"200px"}
                        className="img img-responsive"
                        />
